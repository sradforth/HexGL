...
// Version 3.20  20170612 - Allow a score to be converted to html to display in results with params['on_convert_score_to_html']. params[image_url] added for logo
...
var params=
{
	...
	[image_url] : "http://www.coinmode.com/img/games_empty.jpg" // Optional icon image to show as game title. (256x256 image)
		...
		<div id='coinmode_inner_panel' class='coinmode_box'>                                                              \
			...
			<div class='coinmode_boxtitle_root'>                                                                          \
				<div id='coinmode_boxtitle_gameimage'>                                         \
					<img class='coinmode_image_game_icon' src='{{IMAGEURL}}'>\
				</div>                                         \
...
//	}
	...
	this.add_html = function( on_complete )
	{
		...
		if( !this._html_added )
		{
			...
			{
				var image_url = "http://www.coinmode.com/img/games_empty.jpg"
				if( this.params['image_url'] != null )
				{
					image_url = this.params['image_url'];
				}
				var modified_html = coinmode_login_html.replace( "{{IMAGEURL}}", image_url );
				$(document.body).append(modified_html);
			}
